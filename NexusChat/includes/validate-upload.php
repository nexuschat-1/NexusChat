<?php
    ...
    try{
        if ($_SERVER["REQUEST_METHOD"] === "POST") {
            ...
            if (empty($password) || empty($confrimpass)) {
            ...
            if (empty($errors)) {
                ...
                function check_for_users($con,$username){
                    ...
                    if(mysqli_fetch_assoc($result) == null){
                        ...
                        echo "<div id='error_msg'>
                            ...
                            <?php
                                ...
                                echo "<li>Create another username</li>";
                            ?>
                        <?php echo "</ul></div>"; 
                    }

                }
                check_for_users($con,$username);

                function upload_profile($con,$user_id,$username,$password,$email,$phone,$gender){
                    ...
                    mysqli_close($con); // CHECK WHETHER THIS IS NEEDED OR NOT
                }
                upload_profile($con,$user_id,$username,$password,$email,$phone,$gender);
            } else {
                echo "<div id='error_msg'>
                        <button id='close_error_msg'>X</button>
                        <ul>"; ?>
